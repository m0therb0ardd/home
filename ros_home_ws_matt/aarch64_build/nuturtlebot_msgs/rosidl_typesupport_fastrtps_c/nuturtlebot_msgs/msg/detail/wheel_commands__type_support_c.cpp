...
#include "nuturtlebot_msgs/msg/detail/wheel_commands__rosidl_typesupport_fastrtps_c.h"
...
using _WheelCommands__ros_msg_type = nuturtlebot_msgs__msg__WheelCommands;
...
size_t get_serialized_size_nuturtlebot_msgs__msg__WheelCommands(
  const void * untyped_ros_message,
...
static uint32_t _WheelCommands__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_nuturtlebot_msgs__msg__WheelCommands(
      untyped_ros_message, 0));
}

ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_nuturtlebot_msgs
size_t max_serialized_size_nuturtlebot_msgs__msg__WheelCommands(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = nuturtlebot_msgs__msg__WheelCommands;
    is_plain =
      (
...
static size_t _WheelCommands__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_nuturtlebot_msgs__msg__WheelCommands(
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, nuturtlebot_msgs, msg, WheelCommands)() {
