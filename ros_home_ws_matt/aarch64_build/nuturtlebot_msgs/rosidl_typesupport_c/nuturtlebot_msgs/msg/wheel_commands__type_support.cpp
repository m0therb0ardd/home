...
static const _WheelCommands_type_support_symbol_names_t _WheelCommands_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, nuturtlebot_msgs, msg, WheelCommands)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, nuturtlebot_msgs, msg, WheelCommands)),
  }
};
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_c, nuturtlebot_msgs, msg, WheelCommands)() {
  return &::nuturtlebot_msgs::msg::rosidl_typesupport_c::WheelCommands_message_type_support_handle;
}
