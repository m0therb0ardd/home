...
static const _SensorData_type_support_symbol_names_t _SensorData_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, nuturtlebot_msgs, msg, SensorData)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, nuturtlebot_msgs, msg, SensorData)),
  }
};
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_c, nuturtlebot_msgs, msg, SensorData)() {
  return &::nuturtlebot_msgs::msg::rosidl_typesupport_c::SensorData_message_type_support_handle;
}
