...
static const _SensorData_type_support_symbol_names_t _SensorData_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, nuturtlebot_msgs, msg, SensorData)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, nuturtlebot_msgs, msg, SensorData)),
  }
};
...
{
  return &::nuturtlebot_msgs::msg::rosidl_typesupport_cpp::SensorData_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_cpp, nuturtlebot_msgs, msg, SensorData)() {
  return get_message_type_support_handle<nuturtlebot_msgs::msg::SensorData>();
}
